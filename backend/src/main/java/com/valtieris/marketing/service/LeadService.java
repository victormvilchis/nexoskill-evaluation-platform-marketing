...
import com.valtieris.marketing.api.LeadRequest;
import com.valtieris.marketing.api.LeadResponse;
import com.valtieris.marketing.config.ClientIdentityService;
import com.valtieris.marketing.config.MarketingProperties;
import com.valtieris.marketing.domain.Prospect;
import com.valtieris.marketing.domain.ProspectRepository;
import com.valtieris.marketing.domain.ProspectStatus;
import com.valtieris.marketing.domain.RequestType;
...
public class LeadService {
    ...
    private LeadResponse silentAcceptance(Instant now) {
        return new LeadResponse(ProspectReference.temporary(), "Recibimos tu solicitud. El equipo de Valtieris se pondrá en contacto contigo.", OffsetDateTime.ofInstant(now, ZoneOffset.UTC));
    }

    private String reference(Long id) {
        return ProspectReference.fromId(id);
    }
}
