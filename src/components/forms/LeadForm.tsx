...
export function LeadForm({
  ...
  if (status.type === 'success') {
    return (
      <div className={`${formClass} lead-form--success`} ref={statusRef} role="status" tabIndex={-1}>
        ...
        <p>{status.message || 'El equipo de NexoSkill dará seguimiento a la solicitud comercial.'}</p>
  ...
  return (
    <form aria-busy={status.type === 'sending'} className={formClass} noValidate onSubmit={handleSubmit} ref={formRef}>
