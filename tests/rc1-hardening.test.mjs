...
const [pkg, playwright, workflow, localProfile, prodProfile, errorHandler, correlation, start, stop, gitignore, changelog] = await Promise.all([
  ...
  read('backend/src/main/java/com/valtieris/marketing/api/ApiExceptionHandler.java'),
  read('backend/src/main/java/com/valtieris/marketing/config/RequestCorrelationFilter.java'),
